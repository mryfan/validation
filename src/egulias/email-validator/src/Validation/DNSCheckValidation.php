...
use Fy97Validation\Egulias\EmailValidator\Exception\LocalOrReservedDomain;
use Fy97Validation\Egulias\EmailValidator\Exception\DomainAcceptsNoMail;
use Fy97Validation\Egulias\EmailValidator\Warning\NoDNSMXRecord;
use Fy97Validation\Egulias\EmailValidator\Exception\NoDNSRecord;
