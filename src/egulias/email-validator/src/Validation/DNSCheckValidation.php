...
use Fy\Egulias\EmailValidator\Exception\LocalOrReservedDomain;
use Fy\Egulias\EmailValidator\Exception\DomainAcceptsNoMail;
use Fy\Egulias\EmailValidator\Warning\NoDNSMXRecord;
use Fy\Egulias\EmailValidator\Exception\NoDNSRecord;
