...
use Fy\Egulias\EmailValidator\Validation\Exception\EmptyValidationList;
...
class MultipleValidationWithAnd implements EmailValidation
{
    ...
    /**
     * @param \Fy\Egulias\EmailValidator\Exception\InvalidEmail|null $possibleError
     * @param \Fy\Egulias\EmailValidator\Exception\InvalidEmail[] $errors
     *
     * @return \Fy\Egulias\EmailValidator\Exception\InvalidEmail[]
     */
