...
namespace Fy97Validation\Symfony\Component\Translation\Extractor;

\Fy97Validation\symfony\deprecation_contracts\function_new::trigger_deprecation('symfony/translation', '6.2', '"%s" is deprecated, use "%s" instead.', PhpExtractor::class, PhpAstExtractor::class);
