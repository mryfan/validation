...
namespace Fy97Validation\Symfony\Component\Translation\DependencyInjection;
...
class TranslatorPass implements CompilerPassInterface
{
    ...
    {
        if (0 < \func_num_args()) {
            \Fy97Validation\Fy97Validation/symfony/deprecation-contractfunction_new::trigger_deprecation('symfony/translation', '5.3', 'Configuring "%s" is deprecated.', __CLASS__);
        }
