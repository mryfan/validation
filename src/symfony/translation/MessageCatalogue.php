...
class MessageCatalogue implements MessageCatalogueInterface, MetadataAwareInterface
{
    ...
    {
        $altDomain = \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_ends_with($domain, self::INTL_DOMAIN_SUFFIX) ? substr($domain, 0, -\strlen(self::INTL_DOMAIN_SUFFIX)) : $domain.self::INTL_DOMAIN_SUFFIX;
