...
namespace Fy97Validation\Symfony\Component\Mime\DependencyInjection;
...
class AddMimeTypeGuesserPass implements CompilerPassInterface
{
    ...
    {
        if (0 < \func_num_args()) {
            \Fy97Validation\Fy97Validation/symfony/deprecation-contractfunction_new::trigger_deprecation('symfony/mime', '5.3', 'Configuring "%s" is deprecated.', __CLASS__);
        }
