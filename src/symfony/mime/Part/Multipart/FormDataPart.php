...
namespace Fy97Validation\Symfony\Component\Mime\Part\Multipart;

use Fy97Validation\Symfony\Component\Mime\Exception\InvalidArgumentException;
use Fy97Validation\Symfony\Component\Mime\Part\AbstractMultipartPart;
    ...
    public function __construct(array $fields = [])
    {
        ...
        foreach ($fields as $name => $value) {
            if (!\is_string($value) && !\is_array($value) && !$value instanceof TextPart) {
                throw new InvalidArgumentException(sprintf('A form field value can only be a string, an array, or an instance of TextPart ("%s" given).', \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::get_debug_type($value)));
            }
