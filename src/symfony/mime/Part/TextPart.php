...
use Fy97Validation\Symfony\Component\Mime\Encoder\Base64ContentEncoder;
use Fy97Validation\Symfony\Component\Mime\Encoder\ContentEncoderInterface;
use Fy97Validation\Symfony\Component\Mime\Encoder\EightBitContentEncoder;
use Fy97Validation\Symfony\Component\Mime\Encoder\QpContentEncoder;
...
class TextPart extends AbstractPart
{
    ...
    public function __construct($body, ?string $charset = 'utf-8', string $subtype = 'plain', string $encoding = null)
    {
        ...
        if (!\is_string($body) && !\is_resource($body)) {
            throw new \TypeError(sprintf('The body of "%s" must be a string or a resource (got "%s").', self::class, \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::get_debug_type($body)));
        }
