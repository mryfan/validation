...
namespace Fy97Validation\Symfony\Component\Mime;

use Fy97Validation\Symfony\Component\Mime\Exception\RuntimeException;
use Fy97Validation\Symfony\Component\Mime\Part\DataPart;
use Fy97Validation\Symfony\Component\Mime\Part\Multipart\AlternativePart;
use Fy97Validation\Symfony\Component\Mime\Part\Multipart\MixedPart;
use Fy97Validation\Symfony\Component\Mime\Part\Multipart\RelatedPart;
use Fy97Validation\Symfony\Component\Mime\Part\TextPart;
    ...
    public static function toEmail(Message $message): Email
    {
        ...
        if ($body instanceof MixedPart) {
            ...
            if ($parts[0] instanceof RelatedPart) {
                ...
                throw new RuntimeException(sprintf('Unable to create an Email from an instance of "%s" as the body is too complex.', \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::get_debug_type($message)));
            }
    ...
    private static function attachParts(Email $email, array $parts): Email
    {
        foreach ($parts as $part) {
            if (!$part instanceof DataPart) {
                throw new RuntimeException(sprintf('Unable to create an Email from an instance of "%s" as the body is too complex.', \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::get_debug_type($email)));
            }
