...
use Fy97Validation\Egulias\EmailValidator\Validation\MessageIDValidation;
use Fy97Validation\Egulias\EmailValidator\Validation\RFCValidation;
use Fy97Validation\Symfony\Component\Mime\Encoder\IdnAddressEncoder;
use Fy97Validation\Symfony\Component\Mime\Exception\InvalidArgumentException;
use Fy97Validation\Symfony\Component\Mime\Exception\LogicException;
use Fy97Validation\Symfony\Component\Mime\Exception\RfcComplianceException;
...
final class Address
{
    ...
    public static function create($address): self
    {
        ...
        if (!\is_string($address)) {
            throw new InvalidArgumentException(sprintf('An address can be an instance of Address or a string ("%s" given).', \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::get_debug_type($address)));
        }
    ...
    {
        \Fy97Validation\Fy97Validation/symfony/deprecation-contractfunction_new::trigger_deprecation('symfony/mime', '5.2', '"%s()" is deprecated, use "%s::create()" instead.', __METHOD__, __CLASS__);
