...
class IpUtils
{
    ...
    {
        if (null === $requestIp) {
            \Fy97Validation\deprecation_contracts\function_new::trigger_deprecation('symfony/http-foundation', '5.4', 'Passing null as $requestIp to "%s()" is deprecated, pass an empty string instead.', __METHOD__);
