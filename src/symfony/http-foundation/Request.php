...
namespace Fy\Symfony\Component\HttpFoundation;

use Fy\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Fy\Symfony\Component\HttpFoundation\Exception\JsonException;
use Fy\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use Fy\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Fy\Symfony\Component\HttpFoundation\Session\SessionInterface;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Fy\Symfony\Component\HttpFoundation\Request.');
            }
