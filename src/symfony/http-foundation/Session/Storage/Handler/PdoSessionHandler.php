...
class PdoSessionHandler extends AbstractSessionHandler
{
    ...
    public function __construct($pdoOrDsn = null, array $options = [])
    {
        ...
        } elseif (\is_string($pdoOrDsn) && \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_contains($pdoOrDsn, '://')) {
    ...
    private function buildDsnFromUrl(string $dsnOrUrl): string
    {
        ...
        if (str_starts_with($driver, 'pdo_') || \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_starts_with($driver, 'pdo-')) {
