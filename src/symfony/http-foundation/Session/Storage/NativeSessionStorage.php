...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    {
        if (1 > \func_num_args()) {
            \Fy97Validation\symfony\deprecation_contracts\function_new::trigger_deprecation('symfony/http-foundation', '6.2', 'Calling "%s()" without any arguments is deprecated, pass null explicitly instead.', __METHOD__);
        }
