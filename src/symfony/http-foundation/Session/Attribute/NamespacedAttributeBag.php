...
\Fy97Validation\deprecation_contracts\function_new::trigger_deprecation('symfony/http-foundation', '5.3', 'The "%s" class is deprecated.', NamespacedAttributeBag::class);
