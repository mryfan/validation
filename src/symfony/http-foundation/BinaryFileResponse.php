...
class BinaryFileResponse extends Response
{
    ...
    {
        \Fy97Validation\deprecation_contracts\function_new::trigger_deprecation('symfony/http-foundation', '5.2', 'The "%s()" method is deprecated, use "new %s()" instead.', __METHOD__, static::class);
