...
class BinaryFileResponse extends Response
{
    ...
    {
        \Fy97Validation\Fy97Validation/symfony/deprecation-contractfunction_new::trigger_deprecation('symfony/http-foundation', '5.2', 'The "%s()" method is deprecated, use "new %s()" instead.', __METHOD__, static::class);
    ...
    public function setContentDisposition(string $disposition, string $filename = '', string $filenameFallback = '')
    {
        ...
        if ('' === $filenameFallback && (!preg_match('/^[\x20-\x7e]*$/', $filename) || \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_contains($filename, '%'))) {
