...
/**
 * @template T of Fy97Validation\CarbonInterface
 */
trait Fy97Validation\CarbonTypeConverter
{
    /**
    ...
    {
        return Fy97Validation\Carbon::class;
    }
    ...
    public function convertToDatabaseValue($value, AbstractPlatform $platform)
    {
        ...
        throw ConversionException::conversionFailedInvalidType(
            $value,
            $this->getName(),
            ['null', 'DateTime', 'Fy97Validation\Carbon']
        );
    }
}
