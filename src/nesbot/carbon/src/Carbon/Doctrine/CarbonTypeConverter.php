...
trait Fy\CarbonTypeConverter
{
    protected function getFy\CarbonClassName(): string
    {
        return Fy\Carbon::class;
    }
    ...
    {
        $class = $this->getFy\CarbonClassName();
    ...
    public function convertToDatabaseValue($value, AbstractPlatform $platform)
    {
        ...
        if ($value instanceof DateTimeInterface || $value instanceof Fy\CarbonInterface) {
