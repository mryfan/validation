...
/**
 * A factory to generate Fy97Validation\Carbon instances with common settings.
 *
 ...
 *                                                                                                                                                                                         new instance.
 * @method Fy97Validation\Carbon|false                                       create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)                                     Create a new Fy97Validation\Carbon instance from a specific date and time.
 ...
 *                                                                                                                                                                                         will be 0.
 * @method Fy97Validation\Carbon                                             createFromDate($year = null, $month = null, $day = null, $tz = null)                                                         Create a Fy97Validation\Carbon instance from just a date. The time portion is set to now.
 * @method Fy97Validation\Carbon|false                                       createFromFormat($format, $time, $tz = null)                                                                                 Create a Fy97Validation\Carbon instance from a specific format.
 * @method Fy97Validation\Carbon|false                                       createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)                                          Create a Fy97Validation\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method Fy97Validation\Carbon|false                                       createFromLocaleFormat($format, $locale, $time, $tz = null)                                                                  Create a Fy97Validation\Carbon instance from a specific format and a string in a given language.
 * @method Fy97Validation\Carbon|false                                       createFromLocaleIsoFormat($format, $locale, $time, $tz = null)                                                               Create a Fy97Validation\Carbon instance from a specific ISO format and a string in a given language.
 * @method Fy97Validation\Carbon                                             createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)                                                              Create a Fy97Validation\Carbon instance from just a time. The date portion is set to today.
 * @method Fy97Validation\Carbon                                             createFromTimeString($time, $tz = null)                                                                                      Create a Fy97Validation\Carbon instance from a time string. The date portion is set to today.
 * @method Fy97Validation\Carbon                                             createFromTimestamp($timestamp, $tz = null)                                                                                  Create a Fy97Validation\Carbon instance from a timestamp and set the timezone (use default one if not specified).
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy97Validation\Carbon                                             createFromTimestampMs($timestamp, $tz = null)                                                                                Create a Fy97Validation\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy97Validation\Carbon                                             createFromTimestampMsUTC($timestamp)                                                                                         Create a Fy97Validation\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy97Validation\Carbon                                             createFromTimestampUTC($timestamp)                                                                                           Create a Fy97Validation\Carbon instance from an timestamp keeping the timezone to UTC.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy97Validation\Carbon                                             createMidnightDate($year = null, $month = null, $day = null, $tz = null)                                                     Create a Fy97Validation\Carbon instance from just a date. The time portion is set to midnight.
 * @method Fy97Validation\Carbon|false                                       createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)               Create a new safe Fy97Validation\Carbon instance from a specific date and time.
 *                                                                                                                                                                                         If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                                         be used.
 *                                                                                                                                                                                         If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                                         values for $minute and $second will be their now() values.
 ...
 * @method Fy97Validation\Carbon                                             disableHumanDiffOption($humanDiffOption)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 * @method Fy97Validation\Carbon                                             enableHumanDiffOption($humanDiffOption)                                                                                      @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Fy97Validation\Carbon                                             fromSerialized($value)                                                                                                       Create an instance from a serialized string.
 ...
 * @method Closure|Carbon                                     getTestNow()                                                                                                                 Get the Fy97Validation\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.
 ...
 * @method Fy97Validation\Carbon                                             instance($date)                                                                                                              Create a Fy97Validation\Carbon instance from a DateTime one.
 ...
 * @method Fy97Validation\Carbon|null                                        make($var)                                                                                                                   Make a Fy97Validation\Carbon instance from given variable if possible.
 *                                                                                                                                                                                         Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                                         and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method Fy97Validation\Carbon                                             maxValue()                                                                                                                   Create a Fy97Validation\Carbon instance for the greatest supported date.
 * @method Fy97Validation\Carbon                                             minValue()                                                                                                                   Create a Fy97Validation\Carbon instance for the lowest supported date.
 * @method void                                               mixin($mixin)                                                                                                                Mix another object into the class.
 * @method Fy97Validation\Carbon                                             now($tz = null)                                                                                                              Get a Fy97Validation\Carbon instance for the current date and time.
 * @method Fy97Validation\Carbon                                             parse($time = null, $tz = null)                                                                                              Create a carbon instance from a string.
 ...
 * @method Fy97Validation\Carbon                                             parseFromLocale($time, $locale = null, $tz = null)                                                                           Create a carbon instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string                                             pluralUnit(string $unit)                                                                                                     Returns standardized plural of a given singular/plural unit name (in English).
 * @method Fy97Validation\Carbon|false                                       rawCreateFromFormat($format, $time, $tz = null)                                                                              Create a Fy97Validation\Carbon instance from a specific format.
 * @method Fy97Validation\Carbon                                             rawParse($time = null, $tz = null)                                                                                           Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Fy97Validation\Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Fy97Validation\Carbon('Monday next week'))->fn().
 * @method Fy97Validation\Carbon                                             resetMacros()                                                                                                                Remove all macros and generic macros.
 ...
 * @method Fy97Validation\Carbon                                             setFallbackLocale($locale)                                                                                                   Set the fallback locale.
 * @method Fy97Validation\Carbon                                             setHumanDiffOptions($humanDiffOptions)                                                                                       @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Fy97Validation\Carbon                                             setTestNow($testNow = null)                                                                                                  Set a Fy97Validation\Carbon instance (real or mock) to be returned when a "now"
 ...
 * @method Fy97Validation\Carbon                                             setTestNowAndTimezone($testNow = null, $tz = null)                                                                           Set a Fy97Validation\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.  The provided instance will be returned
 *                                                                                                                                                                                         specifically under the following conditions:
 *                                                                                                                                                                                           - A call to the static now() method, ex. Fy97Validation\Carbon::now()
 *                                                                                                                                                                                           - When a null (or blank string) is passed to the constructor or parse(), ex. new Fy97Validation\Carbon(null)
 ...
 * @method Fy97Validation\Carbon                                             setUtf8($utf8)                                                                                                               @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 ...
 * @method Fy97Validation\Carbon                                             today($tz = null)                                                                                                            Create a Fy97Validation\Carbon instance for today.
 * @method Fy97Validation\Carbon                                             tomorrow($tz = null)                                                                                                         Create a Fy97Validation\Carbon instance for tomorrow.
 ...
 *                                                                                                                                                                                                     Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
 *                                                                                                                                                                                                     are available for quarters, years, decade, centuries, millennia (singular and plural forms).
 * @method Fy97Validation\Carbon                                             useStrictMode($strictModeEnabled = true)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 *                                                                                                                                                                                         /!\ Use this method for unit tests only.
 * @method Fy97Validation\Carbon                                             yesterday($tz = null)                                                                                                        Create a Fy97Validation\Carbon instance for yesterday.
 *
 * </autodoc>
 */
class Factory
{
    protected $className = Fy97Validation\Carbon::class;
    ...
    public function __call($name, $arguments)
    {
        ...
        return $result instanceof Fy97Validation\CarbonInterface && !empty($settings)
