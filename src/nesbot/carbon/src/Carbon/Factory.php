...
/**
 * A factory to generate Fy\Carbon instances with common settings.
 *
 ...
 *                                                                                                                                                                                               new instance.
 * @method Fy\Carbon|false                                       create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)                                           Create a new Fy\Carbon instance from a specific date and time.
 ...
 *                                                                                                                                                                                               will be 0.
 * @method Fy\Carbon                                             createFromDate($year = null, $month = null, $day = null, $tz = null)                                                               Create a Fy\Carbon instance from just a date. The time portion is set to now.
 * @method Fy\Carbon|false                                       createFromFormat($format, $time, $tz = null)                                                                                       Create a Fy\Carbon instance from a specific format.
 * @method Fy\Carbon|false                                       createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)                                                Create a Fy\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method Fy\Carbon|false                                       createFromLocaleFormat($format, $locale, $time, $tz = null)                                                                        Create a Fy\Carbon instance from a specific format and a string in a given language.
 * @method Fy\Carbon|false                                       createFromLocaleIsoFormat($format, $locale, $time, $tz = null)                                                                     Create a Fy\Carbon instance from a specific ISO format and a string in a given language.
 * @method Fy\Carbon                                             createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)                                                                    Create a Fy\Carbon instance from just a time. The date portion is set to today.
 * @method Fy\Carbon                                             createFromTimeString($time, $tz = null)                                                                                            Create a Fy\Carbon instance from a time string. The date portion is set to today.
 * @method Fy\Carbon                                             createFromTimestamp($timestamp, $tz = null)                                                                                        Create a Fy\Carbon instance from a timestamp and set the timezone (use default one if not specified).
 *                                                                                                                                                                                               Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy\Carbon                                             createFromTimestampMs($timestamp, $tz = null)                                                                                      Create a Fy\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                               Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy\Carbon                                             createFromTimestampMsUTC($timestamp)                                                                                               Create a Fy\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                               Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy\Carbon                                             createFromTimestampUTC($timestamp)                                                                                                 Create a Fy\Carbon instance from an timestamp keeping the timezone to UTC.
 *                                                                                                                                                                                               Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Fy\Carbon                                             createMidnightDate($year = null, $month = null, $day = null, $tz = null)                                                           Create a Fy\Carbon instance from just a date. The time portion is set to midnight.
 * @method Fy\Carbon|false                                       createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)                     Create a new safe Fy\Carbon instance from a specific date and time.
 *                                                                                                                                                                                               If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                                               be used.
 *                                                                                                                                                                                               If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                                               values for $minute and $second will be their now() values.
 ...
 *                                                                                                                                                                                               will be thrown.
 * @method Fy\CarbonInterface                                    createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $tz = null)       Create a new Fy\Carbon instance from a specific date and time using strict validation.
 * @method Fy\Carbon                                             disableHumanDiffOption($humanDiffOption)                                                                                           @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                           You should rather use the ->settings() method.
 * @method Fy\Carbon                                             enableHumanDiffOption($humanDiffOption)                                                                                            @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                           You should rather use the ->settings() method.
 ...
 * @method Fy\Carbon                                             fromSerialized($value)                                                                                                             Create an instance from a serialized string.
 ...
 * @method Fy\Carbon                                             getLastErrors()                                                                                                                    {@inheritdoc}
 ...
 * @method Closure|Fy\Carbon                                     getTestNow()                                                                                                                       Get the Fy\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                               instance is created.
 ...
 * @method \Fy\Symfony\Component\Translation\TranslatorInterface getTranslator()                                                                                                                    Get the default translator instance in use.
 ...
 * @method Fy\Carbon                                             instance($date)                                                                                                                    Create a Fy\Carbon instance from a DateTime one.
 ...
 * @method Fy\Carbon|null                                        make($var)                                                                                                                         Make a Fy\Carbon instance from given variable if possible.
 *                                                                                                                                                                                               Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                                               and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method Fy\Carbon                                             maxValue()                                                                                                                         Create a Fy\Carbon instance for the greatest supported date.
 * @method Fy\Carbon                                             minValue()                                                                                                                         Create a Fy\Carbon instance for the lowest supported date.
 * @method void                                               mixin($mixin)                                                                                                                      Mix another object into the class.
 * @method Fy\Carbon                                             now($tz = null)                                                                                                                    Get a Fy\Carbon instance for the current date and time.
 * @method Fy\Carbon                                             parse($time = null, $tz = null)                                                                                                    Create a carbon instance from a string.
 *                                                                                                                                                                                               This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                               as it allows you to do Fy\Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                               than (new Fy\Carbon('Monday next week'))->fn().
 * @method Fy\Carbon                                             parseFromLocale($time, $locale = null, $tz = null)                                                                                 Create a carbon instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string                                             pluralUnit(string $unit)                                                                                                           Returns standardized plural of a given singular/plural unit name (in English).
 * @method Fy\Carbon|false                                       rawCreateFromFormat($format, $time, $tz = null)                                                                                    Create a Fy\Carbon instance from a specific format.
 * @method Fy\Carbon                                             rawParse($time = null, $tz = null)                                                                                                 Create a carbon instance from a string.
 *                                                                                                                                                                                               This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                               as it allows you to do Fy\Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                               than (new Fy\Carbon('Monday next week'))->fn().
 * @method Fy\Carbon                                             resetMacros()                                                                                                                      Remove all macros and generic macros.
 ...
 * @method void                                               resetToStringFormat()                                                                                                              Reset the format used to the default when type juggling a Fy\Carbon instance to a string
 ...
 * @method Fy\Carbon                                             setFallbackLocale($locale)                                                                                                         Set the fallback locale.
 * @method Fy\Carbon                                             setHumanDiffOptions($humanDiffOptions)                                                                                             @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                           You should rather use the ->settings() method.
 ...
 * @method Fy\Carbon                                             setTestNow($testNow = null)                                                                                                        Set a Fy\Carbon instance (real or mock) to be returned when a "now"
 ...
 * @method void                                               setTranslator(\Fy\Symfony\Component\Translation\TranslatorInterface $translator)                                                      Set the default translator instance to use.
 * @method Fy\Carbon                                             setUtf8($utf8)                                                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 ...
 * @method Fy\Carbon                                             today($tz = null)                                                                                                                  Create a Fy\Carbon instance for today.
 * @method Fy\Carbon                                             tomorrow($tz = null)                                                                                                               Create a Fy\Carbon instance for tomorrow.
 * @method string                                             translateTimeString($timeString, $from = null, $to = null, $mode = Fy\CarbonInterface::TRANSLATE_ALL)                                 Translate a time string from a locale to an other.
 * @method string                                             translateWith(\Fy\Symfony\Component\Translation\TranslatorInterface $translator, string $key, array $parameters = [], $number = null) Translate using translation string or callback available.
 ...
 *                                                                                                                                                                                                           Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
 *                                                                                                                                                                                                           are available for quarters, years, decade, centuries, millennia (singular and plural forms).
 * @method Fy\Carbon                                             useStrictMode($strictModeEnabled = true)                                                                                           @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                           You should rather use the ->settings() method.
 ...
 *                                                                                                                                                                                               /!\ Use this method for unit tests only.
 * @method Fy\Carbon                                             yesterday($tz = null)                                                                                                              Create a Fy\Carbon instance for yesterday.
 *
 * </autodoc>
 */
class Factory
{
    protected $className = Fy\Carbon::class;
    ...
    public function __call($name, $arguments)
    {
        ...
        return $result instanceof Fy\CarbonInterface && !empty($settings)
