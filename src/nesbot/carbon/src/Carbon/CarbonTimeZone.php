...
use Fy97Validation\Carbon\Exceptions\InvalidTimeZoneException;
use DateTimeInterface;
use DateTimeZone;
use Throwable;

class Fy97Validation\CarbonTimeZone extends DateTimeZone
{
    ...
    /**
     * Create a Fy97Validation\CarbonTimeZone from mixed input.
     *
     * @param DateTimeZone|string|int|null $object     original value to get Fy97Validation\CarbonTimeZone from it.
    ...
    public function toOffsetName(DateTimeInterface $date = null)
    {
        return static::getOffsetNameFromMinuteOffset(
            $this->getOffset($date ?: Fy97Validation\Carbon::now($this)) / 60
        );
    }

    /**
     * Returns a new Fy97Validation\CarbonTimeZone object using the offset string instead of region string.
     *
     * @param DateTimeInterface|null $date
     *
     * @return Fy97Validation\CarbonTimeZone
     */
    ...
    public function toRegionName(DateTimeInterface $date = null, $isDst = 1)
    {
        ...
        $date = $date ?: Fy97Validation\Carbon::now($this);
    ...
    /**
     * Returns a new Fy97Validation\CarbonTimeZone object using the region string instead of offset string.
     *
     * @param DateTimeInterface|null $date
     *
     * @return Fy97Validation\CarbonTimeZone|false
     */
    public function toRegionTimeZone(DateTimeInterface $date = null)
    {
        ...
        if (Carbon::isStrictModeEnabled()) {
            throw new InvalidTimeZoneException('Unknown timezone for offset '.$this->getOffset($date ?: Fy97Validation\Carbon::now($this)).' seconds.');
        }
    ...
    /**
     * Create a Fy97Validation\CarbonTimeZone from int/float hour offset.
     *
    ...
    {
        return static::createFromMinuteOffset($hourOffset * Fy97Validation\Carbon::MINUTES_PER_HOUR);
    }

    /**
     * Create a Fy97Validation\CarbonTimeZone from int/float minute offset.
     *
