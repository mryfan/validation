...
class Fy97Validation\CarbonPeriod implements Iterator, Countable, JsonSerializable
{
    ...
    public function __call($method, $parameters)
    {
        ...
        switch ($method) {
            ...
            case 'sinceNow':
                return $this->setStartDate(new Fy97Validation\Carbon(), $first);
            ...
            case 'untilNow':
                return $this->setEndDate(new Fy97Validation\Carbon(), $first);
    ...
    {
        return \is_string($callable) && \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_starts_with($callable, 'is') &&
