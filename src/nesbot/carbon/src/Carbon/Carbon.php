 ...
 * @method        static Fy97Validation\Carbon|false createFromFormat(string $format, string $time, string|DateTimeZone $timezone = null) Parse a string into a new Fy97Validation\Carbon object according to the specified format.
 * @method        static Fy97Validation\Carbon       __set_state(array $array)                                                            https://php.net/manual/en/datetime.set-state.php
 *
 * </autodoc>
 */
class Fy97Validation\Carbon extends DateTime implements Fy97Validation\CarbonInterface
{
    use Date;
