 ...
 * @method        static Fy\Carbon|false createFromFormat(string $format, string $time, string|DateTimeZone $timezone = null) Parse a string into a new Fy\Carbon object according to the specified format.
 * @method        static Fy\Carbon       __set_state(array $array)                                                            https://php.net/manual/en/datetime.set-state.php
 *
 * </autodoc>
 */
class Fy\Carbon extends DateTime implements Fy\CarbonInterface
{
    use Date;
