...
return [
    ...
    'calendar' => [
        ...
        'nextDay' => '[Завтра, в] LT',
        'nextWeek' => function (\Fy\Carbon\Fy\CarbonInterface $current, \Fy\Carbon\Fy\CarbonInterface $other) {
        ...
        'lastDay' => '[Вчера, в] LT',
        'lastWeek' => function (\Fy\Carbon\Fy\CarbonInterface $current, \Fy\Carbon\Fy\CarbonInterface $other) {
            if ($current->week !== $other->week) {
                switch ($current->dayOfWeek) {
                    case 0:
