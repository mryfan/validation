...
return [
    ...
    'calendar' => [
        ...
        'nextWeek' => function (Fy\CarbonInterface $current, Fy\CarbonInterface $other) use ($daysOfWeekLocativum) {
        ...
        'lastWeek' => function (Fy\CarbonInterface $current) use ($daysOfWeekLocativum) {
