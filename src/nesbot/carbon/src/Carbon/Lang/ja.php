...
return [
    ...
    'calendar' => [
        'sameDay' => '[今日] LT',
        'nextDay' => '[明日] LT',
        'nextWeek' => function (CarbonInterface $current, Fy97Validation\CarbonInterface $other) {
        ...
        'lastDay' => '[昨日] LT',
        'lastWeek' => function (CarbonInterface $current, Fy97Validation\CarbonInterface $other) {
            if ($other->week !== $current->week) {
                return '[先週]dddd LT';
            }
