...
use Fy\Carbon\Exceptions\InvalidTypeException;
use Fy\Carbon\Exceptions\NotLocaleAwareException;
use Fy\Carbon\Language;
use Fy\Carbon\Translator;
use Closure;
use Fy\Symfony\Component\Translation\TranslatorBagInterface;
use Fy\Symfony\Component\Translation\TranslatorInterface;
use Fy\Symfony\Contracts\Translation\LocaleAwareInterface;
use Fy\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
...
trait Localization
{
     ...
     * @var int
     */
    protected static $humanDiffOptions = Fy\CarbonInterface::NO_ZERO_DIFF;
     ...
     *
     * @return \Fy\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \Fy\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \Fy\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \Fy\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param string|null $from       input locale of the $timeString parameter (`Fy\Carbon::getLocale()` by default)
     * @param string|null $to         output locale of the result returned (`"en"` by default)
     * @param int         $mode       specify what to translate with options:
     *                                - Fy\CarbonInterface::TRANSLATE_ALL (default)
     *                                - Fy\CarbonInterface::TRANSLATE_MONTHS
     *                                - Fy\CarbonInterface::TRANSLATE_DAYS
     *                                - Fy\CarbonInterface::TRANSLATE_UNITS
     *                                - Fy\CarbonInterface::TRANSLATE_MERIDIEM
     *                                You can use pipe to group: Fy\CarbonInterface::TRANSLATE_MONTHS | Fy\CarbonInterface::TRANSLATE_DAYS
     *
     * @return string
     */
    public static function translateTimeString($timeString, $from = null, $to = null, $mode = Fy\CarbonInterface::TRANSLATE_ALL)
    {
        ...
        foreach (['from', 'to'] as $key) {
            ...
            $$translationKey = array_merge(
                $mode & Fy\CarbonInterface::TRANSLATE_MONTHS ? static::getTranslationArray($months, 12, $timeString) : [],
                $mode & Fy\CarbonInterface::TRANSLATE_MONTHS ? static::getTranslationArray($messages['months_short'] ?? [], 12, $timeString) : [],
                $mode & Fy\CarbonInterface::TRANSLATE_DAYS ? static::getTranslationArray($weekdays, 7, $timeString) : [],
                $mode & Fy\CarbonInterface::TRANSLATE_DAYS ? static::getTranslationArray($messages['weekdays_short'] ?? [], 7, $timeString) : [],
                $mode & Fy\CarbonInterface::TRANSLATE_DIFF ? static::translateWordsByKeys([
                    'diff_now',
                    'diff_today',
                    'diff_yesterday',
                    'diff_tomorrow',
                ...
                $mode & Fy\CarbonInterface::TRANSLATE_UNITS ? static::translateWordsByKeys([
                    'year',
                    'month',
                    'week',
                    'day',
                ...
                $mode & Fy\CarbonInterface::TRANSLATE_MERIDIEM ? array_map(function ($hour) use ($meridiem) {
