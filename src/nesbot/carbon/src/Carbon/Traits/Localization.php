...
use Fy97Validation\Carbon\Exceptions\InvalidTypeException;
use Fy97Validation\Carbon\Exceptions\NotLocaleAwareException;
use Fy97Validation\Carbon\Language;
use Fy97Validation\Carbon\Translator;
use Fy97Validation\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Fy97Validation\Symfony\Component\Translation\TranslatorBagInterface;
use Fy97Validation\Symfony\Component\Translation\TranslatorInterface;
use Fy97Validation\Symfony\Contracts\Translation\LocaleAwareInterface;
use Fy97Validation\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
...
trait Localization
{
     ...
     * @var int
     */
    protected static $humanDiffOptions = Fy97Validation\CarbonInterface::NO_ZERO_DIFF;
     ...
     *
     * @return \Fy97Validation\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \Fy97Validation\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \Fy97Validation\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \Fy97Validation\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \Fy97Validation\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     *                                - Fy97Validation\CarbonInterface::TRANSLATE_ALL (default)
     *                                - Fy97Validation\CarbonInterface::TRANSLATE_MONTHS
     *                                - Fy97Validation\CarbonInterface::TRANSLATE_DAYS
     *                                - Fy97Validation\CarbonInterface::TRANSLATE_UNITS
     *                                - Fy97Validation\CarbonInterface::TRANSLATE_MERIDIEM
     *                                You can use pipe to group: Fy97Validation\CarbonInterface::TRANSLATE_MONTHS | Fy97Validation\CarbonInterface::TRANSLATE_DAYS
     *
     * @return string
     */
    public static function translateTimeString($timeString, $from = null, $to = null, $mode = Fy97Validation\CarbonInterface::TRANSLATE_ALL)
    {
        ...
        foreach (['from', 'to'] as $key) {
            ...
            $$translationKey = array_merge(
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_MONTHS ? static::getTranslationArray($months, 12, $timeString) : [],
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_MONTHS ? static::getTranslationArray($messages['months_short'] ?? [], 12, $timeString) : [],
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_DAYS ? static::getTranslationArray($weekdays, 7, $timeString) : [],
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_DAYS ? static::getTranslationArray($messages['weekdays_short'] ?? [], 7, $timeString) : [],
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_DIFF ? static::translateWordsByKeys([
                    'diff_now',
                    'diff_today',
                    'diff_yesterday',
                    'diff_tomorrow',
                ...
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_UNITS ? static::translateWordsByKeys([
                    'year',
                    'month',
                    'week',
                    'day',
                ...
                $mode & Fy97Validation\CarbonInterface::TRANSLATE_MERIDIEM ? array_map(function ($hour) use ($meridiem) {
     ...
     * @param \Fy97Validation\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
