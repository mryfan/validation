...
use Fy97Validation\Carbon\CarbonConverterInterface;
...
trait Units
{
    ...
    public function add($unit, $value = 1, $overflow = null)
    {
        if (\is_string($unit) && \func_num_args() === 1) {
            $unit = Fy97Validation\CarbonInterval::make($unit, [], true);
        }

        if ($unit instanceof Fy97Validation\CarbonConverterInterface) {
