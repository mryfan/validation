...
trait Serialization
{
    ...
    /**
     * The custom Fy\Carbon JSON serializer.
     *
     * @var callable|null
     */
     ...
     *             You should rather transform Fy\Carbon object before the serialization.
     *
     * JSON serialize all Fy\Carbon instances using the given callback.
     *
