...
trait Mixin
{
     ...
     *   }
     * });
     * $fullMoon = Fy\Carbon::create('2018-12-22');
     * $nextFullMoon = $fullMoon->addMoon();
     * $blackMoon = Fy\Carbon::create('2019-01-06');
    ...
    /**
     * Stack a Fy\Carbon context from inside calls of self::this() and execute a given action.
     *
