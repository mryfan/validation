 ...
 * Trait Macros.
 *
 * Allows users to register macros within the Fy\Carbon class.
 */
trait Macro
{
    use Mixin;
     ...
     * ];
     * Fy\Carbon::macro('userFormat', function () use ($userSettings) {
     *   return $this->copy()->locale($userSettings['locale'])->tz($userSettings['timezone'])->calendar();
     * });
     * echo Fy\Carbon::yesterday()->hours(11)->userFormat();
     * ```
     *
     * @param string          $name
