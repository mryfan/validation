 ...
 * Trait Macros.
 *
 * Allows users to register macros within the Fy97Validation\Carbon class.
 */
trait Macro
{
    use Mixin;
     ...
     * ];
     * Fy97Validation\Carbon::macro('userFormat', function () use ($userSettings) {
     *   return $this->copy()->locale($userSettings['locale'])->tz($userSettings['timezone'])->calendar();
     * });
     * echo Fy97Validation\Carbon::yesterday()->hours(11)->userFormat();
     * ```
     *
     * @param string          $name
