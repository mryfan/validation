...
use Fy97Validation\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    /**
     * Reset the format used to the default when type juggling a Fy97Validation\Carbon instance to a string
     *
     * @return void
     */
     ...
     *             You should rather let Fy97Validation\Carbon object being casted to string with DEFAULT_TO_STRING_FORMAT, and
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now(); // Fy97Validation\Carbon instances can be casted to string
     * ```
     *
     * @return string
     */
        ...
        return $format instanceof Closure
            ...
            : $this->rawFormat($format ?: (
                \defined('static::DEFAULT_TO_STRING_FORMAT')
                    ...
                    : Fy97Validation\CarbonInterface::DEFAULT_TO_STRING_FORMAT
            ));
    }
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toDateString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toFormattedDateString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toFormattedDayDateString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toTimeString();
     * ```
     *
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toDateTimeString();
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toDateTimeLocalString();
     * echo "\n";
     * echo Fy97Validation\Carbon::now()->toDateTimeLocalString('minute'); // You can specify precision among: minute, second, millisecond and microsecond
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toDayDateTimeString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toAtomString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toCookieString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toIso8601String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc822String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toIso8601ZuluString();
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc850String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc1036String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc1123String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc2822String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc3339String() . "\n";
     * echo Fy97Validation\Carbon::now()->toRfc3339String(true) . "\n";
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRssString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toW3cString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toRfc7231String();
     * ```
     *
     * @return string
     */
    public function toRfc7231String()
    {
        return $this->avoidMutation()
            ->setTimezone('GMT')
            ->rawFormat(\defined('static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : Fy97Validation\CarbonInterface::RFC7231_FORMAT);
    }
    ...
    public function toArray()
    {
        return [
            ...
            'formatted' => $this->rawFormat(\defined('static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : Fy97Validation\CarbonInterface::DEFAULT_TO_STRING_FORMAT),
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now()->toString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now('America/Toronto')->toISOString() . "\n";
     * echo Fy97Validation\Carbon::now('America/Toronto')->toISOString(true) . "\n";
     * ```
     *
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now('America/Toronto')->toJSON();
     * ```
     *
     * @return null|string
     */
    ...
    /**
     * Create a iterable Fy97Validation\CarbonPeriod object from current date to a given end date (and optional interval).
     *
    ...
    {
        if ($unit) {
            $interval = Fy97Validation\CarbonInterval::make("$interval ".static::pluralUnit($unit));
        }

        $period = (new Fy97Validation\CarbonPeriod())->setDateClass(static::class)->setStartDate($this);
