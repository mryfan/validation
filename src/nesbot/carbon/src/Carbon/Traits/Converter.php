...
use Fy\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    /**
     * Reset the format used to the default when type juggling a Fy\Carbon instance to a string
     *
     * @return void
     */
     ...
     *             You should rather let Fy\Carbon object being casted to string with DEFAULT_TO_STRING_FORMAT, and
     *             use other method or custom format passed to format() method if you need to dump an other string
     *             format.
     *
     * Set the default format used when type juggling a Fy\Carbon instance to a string
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now(); // Fy\Carbon instances can be casted to string
     * ```
     *
     * @return string
     */
        ...
        return $format instanceof Closure
            ...
            : $this->rawFormat($format ?: (
                \defined('static::DEFAULT_TO_STRING_FORMAT')
                    ...
                    : Fy\CarbonInterface::DEFAULT_TO_STRING_FORMAT
            ));
    }
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toDateString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toFormattedDateString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toTimeString();
     * ```
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toDateTimeString();
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toDateTimeLocalString();
     * echo "\n";
     * echo Fy\Carbon::now()->toDateTimeLocalString('minute'); // You can specify precision among: minute, second, millisecond and microsecond
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toDayDateTimeString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toAtomString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toCookieString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toIso8601String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc822String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toIso8601ZuluString();
     * ```
     *
     * @param string $unitPrecision
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc850String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc1036String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc1123String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc2822String();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc3339String() . "\n";
     * echo Fy\Carbon::now()->toRfc3339String(true) . "\n";
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRssString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toW3cString();
     * ```
     *
     * @return string
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->toRfc7231String();
     * ```
     *
     * @return string
     */
    public function toRfc7231String()
    {
        return $this->copy()
            ->setTimezone('GMT')
            ->rawFormat(\defined('static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : Fy\CarbonInterface::RFC7231_FORMAT);
    }
     ...
     * @example
     * ```
     * var_dump(Fy\Carbon::now()->toArray());
     * ```
     *
     * @return array
     */
    public function toArray()
    {
        return [
            ...
            'formatted' => $this->rawFormat(\defined('static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : Fy\CarbonInterface::DEFAULT_TO_STRING_FORMAT),
     ...
     * @example
     * ```
     * var_dump(Fy\Carbon::now()->toObject());
     * ```
     *
     * @return object
     */
     ...
     * @example
     * ```
     * echo Fy\Carbon::now('America/Toronto')->toISOString() . "\n";
     * echo Fy\Carbon::now('America/Toronto')->toISOString(true) . "\n";
     * ```
     *
     ...
     * @example
     * ```
     * echo Fy\Carbon::now('America/Toronto')->toJSON();
     * ```
     *
     * @return null|string
     */
     ...
     * @example
     * ```
     * var_dump(Fy\Carbon::now()->toDateTime());
     * ```
     *
     * @return DateTime
     */
     ...
     * @example
     * ```
     * var_dump(Fy\Carbon::now()->toDateTimeImmutable());
     * ```
     *
    ...
    /**
     * Create a iterable Fy\CarbonPeriod object from current date to a given end date (and optional interval).
     *
     * @param \DateTimeInterface|Fy\Carbon|Fy\CarbonImmutable|int|null $end      period end date or recurrences count if int
    ...
    {
        if ($unit) {
            $interval = Fy\CarbonInterval::make("$interval ".static::pluralUnit($unit));
        }

        $period = (new Fy\CarbonPeriod())->setDateClass(static::class)->setStartDate($this);
     ...
     * Create a iterable Fy\CarbonPeriod object from current date to a given end date (and optional interval).
     *
     * @param \DateTimeInterface|Fy\Carbon|Fy\CarbonImmutable|null $end      period end date
     * @param int|\DateInterval|string|null                  $interval period default interval or number of the given $unit
     * @param string|null                                    $unit     if specified, $interval must be an integer
     *
     * @return Fy\CarbonPeriod
