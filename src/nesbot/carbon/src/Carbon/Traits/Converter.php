...
use Fy97Validation\Carbon\CarbonPeriodImmutable;
...
trait Converter
{
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::now(); // Fy97Validation\Carbon instances can be cast to string
     * ```
     *
     * @return string
     */
    ...
    public function toPeriod($end = null, $interval = null, $unit = null)
    {
        ...
        $period = ($this->isMutable() ? new Fy97Validation\CarbonPeriod() : new Fy97Validation\CarbonPeriodImmutable())
