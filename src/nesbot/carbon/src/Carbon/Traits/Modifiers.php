...
trait Modifiers
{
     ...
     * (second-precision).
     *
     * @param \Fy\Carbon\Fy\Carbon|\DateTimeInterface|null $date
     *
     * @return static
     */
    public function average($date = null)
    {
        return $this->addRealMicroseconds((int) ($this->diffInRealMicroseconds($this->resolveFy\Carbon($date), false) / 2));
    }
     ...
     * @example
     * ```
     * echo Fy\Carbon::now()->change('next 2pm');
     * ```
     *
