 ...
 * Trait Options.
 *
 * Embed base methods to change settings of Fy\Carbon classes.
 *
 * Depends on the following methods:
 *
 * @method \Fy\Carbon\Fy\Carbon|\Fy\Carbon\Fy\CarbonImmutable shiftTimezone($timezone) Set the timezone
 */
trait Options
{
    use Localization;
     ...
     * @var int|string
     */
    protected static $weekStartsAt = Fy\CarbonInterface::MONDAY;
     ...
     * @var int|string
     */
    protected static $weekEndsAt = Fy\CarbonInterface::SUNDAY;
    ...
    protected static $weekendDays = [
        Fy\CarbonInterface::SATURDAY,
        Fy\CarbonInterface::SUNDAY,
    ];
    ...
    {
        if ($this instanceof Fy\CarbonInterface || $this instanceof DateTimeInterface) {
            try {
                if (!isset($infos['date'])) {
                    $infos['date'] = $this->format(Fy\CarbonInterface::MOCK_DATETIME_FORMAT);
                }
