 ...
 * Trait Options.
 *
 * Embed base methods to change settings of Fy97Validation\Carbon classes.
 *
 * Depends on the following methods:
 *
 * @method \Fy97Validation\Carbon\Carbon|\Carbon\CarbonImmutable shiftTimezone($timezone) Set the timezone
 */
trait Options
{
    use Localization;
     ...
     * @var int|string
     */
    protected static $weekStartsAt = Fy97Validation\CarbonInterface::MONDAY;
     ...
     * @var int|string
     */
    protected static $weekEndsAt = Fy97Validation\CarbonInterface::SUNDAY;
    ...
    protected static $weekendDays = [
        Fy97Validation\CarbonInterface::SATURDAY,
        Fy97Validation\CarbonInterface::SUNDAY,
    ];
