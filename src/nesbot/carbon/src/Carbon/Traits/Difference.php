...
trait Difference
{
     ...
     * @codeCoverageIgnore
     *
     * @param Fy97Validation\CarbonInterval $diff
     */
    ...
    {
        $diff = Fy97Validation\CarbonInterval::instance($diff, $skip);
     ...
     * current one).
     *
     * @param \Fy97Validation\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
    ...
    /**
     * Get the difference as a Fy97Validation\CarbonInterval instance.
     * Return relative interval (negative if $absolute flag is not set to true and the given date is before
     * current one).
     *
     * @param \Fy97Validation\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
     ...
     *
     * @param Fy97Validation\CarbonInterval                                         $ci       An interval to traverse by
     * @param Closure                                                $callback
     * @param \Fy97Validation\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
     * @param bool                                                   $absolute Get the absolute of the difference
     *
    ...
    public function diffFiltered(CarbonInterval $ci, Closure $callback, $date = null, $absolute = true)
    {
        ...
        $options = Fy97Validation\CarbonPeriod::EXCLUDE_END_DATE | ($this->isMutable() ? 0 : Fy97Validation\CarbonPeriod::IMMUTABLE);
    ...
    {
        /** @var Fy97Validation\CarbonInterface $date */
    ...
    public function floatDiffInMonths($date = null, $absolute = true)
    {
        ...
        /** @var Fy97Validation\Carbon|CarbonImmutable $floorEnd */
        ...
        /** @var Fy97Validation\Carbon|CarbonImmutable $startOfMonthAfterFloorEnd */
    ...
    public function floatDiffInYears($date = null, $absolute = true)
    {
        ...
        /** @var Fy97Validation\Carbon|CarbonImmutable $startOfYearAfterFloorEnd */
     ...
     * @example
     * ```
     * echo Fy97Validation\Carbon::tomorrow()->diffForHumans() . "\n";
     * echo Fy97Validation\Carbon::tomorrow()->diffForHumans(['parts' => 2]) . "\n";
     * echo Fy97Validation\Carbon::tomorrow()->diffForHumans(['parts' => 3, 'join' => true]) . "\n";
     * echo Fy97Validation\Carbon::tomorrow()->diffForHumans(Carbon::yesterday()) . "\n";
     * echo Fy97Validation\Carbon::tomorrow()->diffForHumans(Carbon::yesterday(), ['short' => true]) . "\n";
     * ```
     *
     * @param Fy97Validation\Carbon|\DateTimeInterface|string|array|null $other   if array passed, will be used as parameters array, see $syntax below;
    ...
    {
        if (!$syntax && !$other) {
            $syntax = Fy97Validation\CarbonInterface::DIFF_RELATIVE_TO_NOW;
        }
    ...
    public function timespan($other = null, $timezone = null)
    {
        ...
        return $this->diffForHumans($other, [
            ...
            'options' => Fy97Validation\CarbonInterface::NO_ZERO_DIFF,
            'parts' => -1,
        ]);
    }
     ...
     *
     * @param Fy97Validation\Carbon|\DateTimeInterface|string|null $referenceTime
     * @param array                                 $formats
     *
     * @return string
     */
    ...
    {
        /** @var Fy97Validation\CarbonInterface $current */
