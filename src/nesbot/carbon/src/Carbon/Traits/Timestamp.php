...
{
    /**
     * Create a Fy97Validation\Carbon instance from a timestamp and set the timezone (use default one if not specified).
     *
    ...
    /**
     * Create a Fy97Validation\Carbon instance from an timestamp keeping the timezone to UTC.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     *
     * @param float|int|string $timestamp
    ...
    /**
     * Create a Fy97Validation\Carbon instance from a timestamp in milliseconds.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     *
     * @param float|int|string $timestamp
    ...
    private static function getIntegerAndDecimalParts($numbers, $decimals = 6)
    {
        ...
        $sign = \Fy97Validation\Symfony\Polyfill\Php80\bootstrap_new::str_starts_with($numbers, '-') ? -1 : 1;
        $integer = 0;
        $decimal = 0;
