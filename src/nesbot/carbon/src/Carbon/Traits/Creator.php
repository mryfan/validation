...
use Fy\Carbon\Exceptions\InvalidDateException;
use Fy\Carbon\Exceptions\InvalidFormatException;
use Fy\Carbon\Exceptions\OutOfRangeException;
 ...
 *
 * @method static Fy\Carbon|Fy\CarbonImmutable getTestNow()
 */
trait Creator
{
    ...
    /**
     * Create a new Fy\Carbon instance.
     *
    ...
    /**
     * Create a Fy\Carbon instance from a DateTime one.
     *
     * @param DateTimeInterface $date
     *
     * @return static
    ...
    public static function instance($date)
    {
        ...
        if ($date instanceof Fy\CarbonInterface || $date instanceof Options) {
     ...
     * as it allows you to do Fy\Carbon::parse('Monday next week')->fn() rather
     * than (new Fy\Carbon('Monday next week'))->fn().
     *
    ...
    /**
     * Get a Fy\Carbon instance for the current date and time.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Fy\Carbon instance for today.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Fy\Carbon instance for tomorrow.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Fy\Carbon instance for yesterday.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Fy\Carbon instance for the greatest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a Fy\Carbon instance for the lowest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a new Fy\Carbon instance from a specific date and time.
     *
    ...
    /**
     * Create a new safe Fy\Carbon instance from a specific date and time.
     *
     * If any of $year, $month or $day are set to null their now() values will
     * be used.
     *
    ...
    /**
     * Create a new Fy\Carbon instance from a specific date and time using strict validation.
     *
     * @see create()
     *
     * @param int|null                 $year
    ...
    /**
     * Create a Fy\Carbon instance from just a date. The time portion is set to now.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a Fy\Carbon instance from just a date. The time portion is set to midnight.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a Fy\Carbon instance from just a time. The date portion is set to today.
     *
     * @param int|null                 $hour
     * @param int|null                 $minute
     * @param int|null                 $second
    ...
    /**
     * Create a Fy\Carbon instance from a time string. The date portion is set to today.
     *
     * @param string                   $time
     * @param DateTimeZone|string|null $tz
     *
    ...
    /**
     * Create a Fy\Carbon instance from a specific format.
     *
     * @param string                         $format Datetime format
     * @param string                         $time
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \Fy\Carbon\Fy\CarbonImmutable|\Fy\Carbon\Fy\Carbon|null $mock */
    ...
    /**
     * Create a Fy\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
     *
     * @param string                                             $format     Datetime format
     * @param string                                             $time
     * @param DateTimeZone|string|false|null                     $tz         optional timezone
     * @param string|null                                        $locale     locale to be used for LTS, LT, LL, LLL, etc. macro-formats (en by fault, unneeded if no such macro-format in use)
     * @param \Fy\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
    ...
    public static function createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)
    {
        ...
        $format = preg_replace_callback('/(?<!\\\\)(\\\\{2})*('.Fy\CarbonInterface::ISO_FORMAT_REGEXP.'|[A-Za-z])/', function ($match) {
            [$code] = $match;
    ...
    /**
     * Create a Fy\Carbon instance from a specific format and a string in a given language.
     *
     * @param string                         $format Datetime format
     * @param string                         $locale
     * @param string                         $time
    ...
    /**
     * Create a Fy\Carbon instance from a specific ISO format and a string in a given language.
     *
    ...
    {
        $time = static::translateTimeString($time, $locale, 'en', Fy\CarbonInterface::TRANSLATE_MONTHS | Fy\CarbonInterface::TRANSLATE_DAYS | Fy\CarbonInterface::TRANSLATE_MERIDIEM);

        return static::createFromIsoFormat($format, $time, $tz, $locale);
    }

    /**
     * Make a Fy\Carbon instance from given variable if possible.
     *
