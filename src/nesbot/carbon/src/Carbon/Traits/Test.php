...
use Fy97Validation\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
    ...
    /**
     * A test Fy97Validation\Carbon instance to be returned when now instances are created.
     *
    ...
    /**
     * Set a Fy97Validation\Carbon instance (real or mock) to be returned when a "now"
     ...
     *
     * @param DateTimeInterface|Closure|static|string|false|null $testNow real or mock Fy97Validation\Carbon instance
     */
    ...
    /**
     * Get the Fy97Validation\Carbon instance (real or mock) to be returned when a "now"
     * instance is created.
     *
     ...
     *
     * @return \Fy97Validation\Carbon\CarbonImmutable|\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \Fy97Validation\Carbon\CarbonImmutable|\Carbon\Carbon|null $testNow */

        return $testNow instanceof Fy97Validation\CarbonInterface
    ...
    {
        /** @var \Fy97Validation\Carbon\CarbonImmutable|\Carbon\Carbon $testInstance */
