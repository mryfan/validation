...
use Generator;
use Fy97Validation\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use Fy97Validation\Illuminate\Support\Traits\EnumeratesValues;
 ...
 * @template TValue
 *
 * @implements \Fy97Validation\Illuminate\Support\Enumerable<TKey, TValue>
 */
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Fy97Validation\Illuminate\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $source
     * @return void
     */
     ...
     * @template TMakeValue
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $items
    ...
    {
        if (func_num_args() === 2) {
            return $this->contains(fn ($item) => \Fy97Validation\Illuminate\Support\helpers_new::data_get($item, $key) === $value);
        }
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$arrays
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Fy97Validation\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>  $keys
     * @return static
     */
    ...
    public function last(callable $callback = null, $default = null)
    {
        ...
        return $needle === $placeholder ? \Fy97Validation\Illuminate\Support\helpers_new::value($default) : $needle;
    }
    ...
    public function pluck($value, $key = null)
    {
        return new static(function () use ($value, $key) {
            ...
            foreach ($this as $item) {
                $itemValue = \Fy97Validation\Illuminate\Support\helpers_new::data_get($item, $value);

                if (is_null($key)) {
                    yield $itemValue;
                } else {
                    $itemKey = \Fy97Validation\Illuminate\Support\helpers_new::data_get($item, $key);
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Fy97Validation\Illuminate\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Fy97Validation\Illuminate\Support\ItemNotFoundException
     * @throws \Fy97Validation\Illuminate\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
