 ...
 *
 * @method \Fy97Validation\Illuminate\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \Fy97Validation\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon fromSerialized($value)
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon|null getTestNow()
 * @method \Fy97Validation\Symfony\Component\Translation\TranslatorInterface getTranslator()
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon instance($date)
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon|null make($var)
 * @method \Fy97Validation\Illuminate\Support\Carbon maxValue()
 * @method \Fy97Validation\Illuminate\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \Fy97Validation\Illuminate\Support\Carbon now($tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon today($tz = null)
 * @method \Fy97Validation\Illuminate\Support\Carbon tomorrow($tz = null)
 ...
 * @method \Fy97Validation\Illuminate\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
