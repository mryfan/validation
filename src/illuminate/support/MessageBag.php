...
use Fy97Validation\Illuminate\Contracts\Support\MessageBag as MessageBagContract;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Support\MessageProvider|array  $messages
     * @return $this
     */
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->messages)
    ...
    protected function transform($messages, $format, $messageKey)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect((array) $messages)
