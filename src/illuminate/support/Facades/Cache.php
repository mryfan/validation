...
/**
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Repository store(string|null $name = null)
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Repository driver(string|null $driver = null)
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Repository resolve(string $name)
 ...
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Store getStore()
 * @method static \Illuminate\Cache\Repository setStore(\Illuminate\Contracts\Cache\Store $store)
 * @method static \Fy97Validation\Illuminate\Contracts\Events\Dispatcher getEventDispatcher()
 ...
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Lock lock(string $name, int $seconds = 0, string|null $owner = null)
 * @method static \Fy97Validation\Illuminate\Contracts\Cache\Lock restoreLock(string $name, string $owner)
 *
