 ...
 * @method static \Illuminate\Process\PendingProcess \Fy97Validation\Illuminate\Support\helpers1_new::env(array $environment)
 ...
 * @method static \Fy97Validation\Illuminate\Contracts\Process\ProcessResult run(array|string|null $command = null, callable|null $output = null)
 ...
 * @method static \Illuminate\Process\Factory recordIfRecording(\Illuminate\Process\PendingProcess $process, \Fy97Validation\Illuminate\Contracts\Process\ProcessResult $result)
 * @method static \Illuminate\Process\Factory record(\Illuminate\Process\PendingProcess $process, \Fy97Validation\Illuminate\Contracts\Process\ProcessResult $result)
