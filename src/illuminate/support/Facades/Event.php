...
use Fy97Validation\Illuminate\Support\Testing\Fakes\EventFake;
 ...
 * @method static \Fy97Validation\Illuminate\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Fy97Validation\Illuminate\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 *
 * @see \Illuminate\Events\Dispatcher
 * @see \Fy97Validation\Illuminate\Support\Testing\Fakes\EventFake
 */
class Event extends Facade
{
     ...
     * @return \Fy97Validation\Illuminate\Support\Testing\Fakes\EventFake
     */
    public static function fake($eventsToFake = [])
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(new EventFake($actualDispatcher, $eventsToFake), function ($fake) {
            static::swap($fake);
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap($callable(), function () use ($originalDispatcher) {
