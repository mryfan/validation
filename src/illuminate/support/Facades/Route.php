 ...
 * @method static \Illuminate\Routing\Route substituteBindings(\Fy\Illuminate\Support\Facades\Route $route)
 ...
 * @method static void substituteImplicitBindings(\Fy\Illuminate\Support\Facades\Route $route)
