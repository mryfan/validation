...
use Fy97Validation\Illuminate\Contracts\Bus\Dispatcher as BusDispatcherContract;
use Illuminate\Foundation\Bus\PendingChain;
use Fy97Validation\Illuminate\Support\Testing\Fakes\BusFake;
 ...
 * @method static \Fy97Validation\Illuminate\Support\Collection dispatched(string $command, callable|null $callback = null)
 * @method static \Fy97Validation\Illuminate\Support\Collection dispatchedSync(string $command, callable|null $callback = null)
 * @method static \Fy97Validation\Illuminate\Support\Collection dispatchedAfterResponse(string $command, callable|null $callback = null)
 * @method static \Fy97Validation\Illuminate\Support\Collection batched(callable $callback)
 ...
 * @see \Fy97Validation\Illuminate\Support\Testing\Fakes\BusFake
 */
class Bus extends Facade
{
     ...
     * @return \Fy97Validation\Illuminate\Support\Testing\Fakes\BusFake
     */
    public static function fake($jobsToFake = [], BatchRepository $batchRepository = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(new BusFake($actualDispatcher, $jobsToFake, $batchRepository), function ($fake) {
            static::swap($fake);
        });
    }
