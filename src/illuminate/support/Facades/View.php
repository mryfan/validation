...
/**
 * @method static \Fy97Validation\Illuminate\Contracts\View\View file(string $path, \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Fy97Validation\Illuminate\Contracts\View\View make(string $view, \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \Fy97Validation\Illuminate\Contracts\View\View first(array $views, \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \Fy97Validation\Illuminate\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \Fy97Validation\Illuminate\Contracts\Container\Container getContainer()
