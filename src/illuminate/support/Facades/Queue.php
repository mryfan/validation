...
use Fy\Illuminate\Support\Testing\Fakes\QueueFake;

/**
 * @method static \Fy\Illuminate\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \Fy\Illuminate\Contracts\Queue\Queue setConnectionName(string $name)
...
class Queue extends Facade
{
     ...
     *
     * @return \Fy\Illuminate\Support\Testing\Fakes\QueueFake
     */
