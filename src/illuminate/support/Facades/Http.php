 ...
 * @method static \Fy97Validation\Illuminate\Support\Collection recorded(callable $callback = null)
 * @method static \Fy97Validation\Illuminate\Contracts\Events\Dispatcher|null getDispatcher()
 ...
 * @method static \Illuminate\Http\Client\PendingRequest \Fy97Validation\Illuminate\Support\helpers1_new::retry(int $times, int $sleepMilliseconds = 0, callable|null $when = null, bool $throw = true)
 ...
 * @method static \Illuminate\Http\Client\Response \Fy97Validation\Illuminate\Support\helpers_new::head(string $url, array|string|null $query = null)
...
class Http extends Facade
{
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(static::getFacadeRoot(), function ($fake) use ($callback) {
    ...
    {
        $fake = \Fy97Validation\Illuminate\Support\helpers1_new::tap(static::getFacadeRoot(), function ($fake) {
            static::swap($fake);
        });
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(static::getFacadeRoot(), function ($fake) {
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(static::getFacadeRoot(), function ($fake) use ($url, $callback) {
