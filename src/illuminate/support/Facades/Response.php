...
use Fy97Validation\Illuminate\Contracts\Routing\ResponseFactory as ResponseFactoryContract;
 ...
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\BinaryFileResponse download(\SplFileInfo|string $file, string|null $name = null, array $headers = [], string|null $disposition = 'attachment')
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\BinaryFileResponse file($file, array $headers = [])
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\StreamedResponse stream(\Closure $callback, int $status = 200, array $headers = [])
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\StreamedResponse streamDownload(\Closure $callback, string|null $name = null, array $headers = [], string|null $disposition = 'attachment')
 *
 * @see \Fy97Validation\Illuminate\Contracts\Routing\ResponseFactory
 */
