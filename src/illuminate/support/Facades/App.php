...
/**
 * @method static \Fy97Validation\Illuminate\Contracts\Foundation\Application loadEnvironmentFrom(string $file)
 * @method static \Fy97Validation\Illuminate\Support\ServiceProvider register(\Illuminate\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \Fy97Validation\Illuminate\Support\ServiceProvider resolveProvider(string $provider)
 ...
 *
 * @see \Fy97Validation\Illuminate\Contracts\Foundation\Application
 */
