...
use Fy\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static \Illuminate\Notifications\ChannelManager locale(string|null $locale)
 * @method static \Fy\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable $callback = null)
 ...
 * @method static void send(\Fy\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 * @method static void sendNow(\Fy\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 *
...
class Notification extends Facade
{
     ...
     *
     * @return \Fy\Illuminate\Support\Testing\Fakes\NotificationFake
     */
