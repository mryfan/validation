...
use Fy97Validation\Illuminate\Support\Testing\Fakes\NotificationFake;
 ...
 * @method static \Fy97Validation\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable|null $callback = null)
 ...
 * @see \Fy97Validation\Illuminate\Support\Testing\Fakes\NotificationFake
 */
class Notification extends Facade
{
     ...
     *
     * @return \Fy97Validation\Illuminate\Support\Testing\Fakes\NotificationFake
     */
    public static function fake()
    {
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(new NotificationFake, function ($fake) {
            static::swap($fake);
        });
    }
