...
use Fy97Validation\Illuminate\Support\Testing\Fakes\MailFake;

/**
 * @method static \Fy97Validation\Illuminate\Contracts\Mail\Mailer mailer(string|null $name = null)
 ...
 * @method static mixed onQueue(string $queue, \Fy97Validation\Illuminate\Contracts\Mail\Mailable $view)
 * @method static mixed queueOn(string $queue, \Fy97Validation\Illuminate\Contracts\Mail\Mailable $view)
 * @method static mixed later(\DateTimeInterface|\DateInterval|int $delay, \Fy97Validation\Illuminate\Contracts\Mail\Mailable $view, string|null $queue = null)
 * @method static mixed laterOn(string $queue, \DateTimeInterface|\DateInterval|int $delay, \Fy97Validation\Illuminate\Contracts\Mail\Mailable $view)
 * @method static \Symfony\Component\Mailer\Transport\TransportInterface getSymfonyTransport()
 * @method static \Fy97Validation\Illuminate\Contracts\View\Factory getViewFactory()
 ...
 * @method static \Fy97Validation\Illuminate\Support\Collection sent(string|\Closure $mailable, callable|null $callback = null)
 * @method static bool hasSent(string $mailable)
 * @method static \Fy97Validation\Illuminate\Support\Collection queued(string|\Closure $mailable, callable|null $callback = null)
 * @method static bool hasQueued(string $mailable)
 *
 * @see \Illuminate\Mail\MailManager
 * @see \Fy97Validation\Illuminate\Support\Testing\Fakes\MailFake
 */
class Mail extends Facade
{
     ...
     *
     * @return \Fy97Validation\Illuminate\Support\Testing\Fakes\MailFake
     */
    public static function fake()
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers1_new::tap(new MailFake($actualMailManager), function ($fake) {
            static::swap($fake);
        });
    }
