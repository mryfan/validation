 ...
 * @method static \Fy97Validation\Illuminate\Support\LazyCollection lines(string $path)
 ...
 * @method static \Fy97Validation\Symfony\Component\Finder\SplFileInfo[] files(string $directory, bool $hidden = false)
 * @method static \Fy97Validation\Symfony\Component\Finder\SplFileInfo[] allFiles(string $directory, bool $hidden = false)
 ...
 * @method static \Fy97Validation\Illuminate\Filesystem\Filesystem|mixed when(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
 * @method static \Fy97Validation\Illuminate\Filesystem\Filesystem|mixed unless(\Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \Fy97Validation\Illuminate\Filesystem\Filesystem
 */
