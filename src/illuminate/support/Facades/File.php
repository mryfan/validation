...
/**
 * @method static \Fy\Symfony\Component\Finder\SplFileInfo[] allFiles(string $directory, bool $hidden = false)
 * @method static \Fy\Symfony\Component\Finder\SplFileInfo[] files(string $directory, bool $hidden = false)
