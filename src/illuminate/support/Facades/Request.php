 ...
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\ParameterBag|mixed json(string|null $key = null, mixed $default = null)
 ...
 * @method static \Fy97Validation\Symfony\Component\HttpFoundation\Session\SessionInterface getSession()
 * @method static \Fy97Validation\Illuminate\Contracts\Session\Session session()
 ...
 * @method static bool \Fy97Validation\Illuminate\Support\helpers1_new::filled(string|array $key)
 ...
 * @method static \Fy97Validation\Illuminate\Support\Stringable \Fy97Validation\Illuminate\Support\helpers1_new::str(string $key, mixed $default = null)
 * @method static \Fy97Validation\Illuminate\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \Fy97Validation\Illuminate\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \Fy97Validation\Illuminate\Support\Collection \Fy97Validation\Illuminate\Support\helpers_new::collect(array|string|null $key = null)
