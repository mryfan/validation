...
use Fy97Validation\Illuminate\Support\Traits\Tappable;
...
class Stringable implements JsonSerializable, ArrayAccess
{
     ...
     *
     * @param  \Fy97Validation\Illuminate\Support\Stringable|string  $value
     * @return bool
     */
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect(explode($delimiter, $this->value, $limit));
    }
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        if (filter_var($pattern, FILTER_VALIDATE_INT) !== false) {
            return \Fy97Validation\Illuminate\Support\helpers_new::collect(mb_str_split($this->value, $pattern));
        }

        $segments = preg_split($pattern, $this->value, $limit, $flags);

        return ! empty($segments) ? \Fy97Validation\Illuminate\Support\helpers_new::collect($segments) : \Fy97Validation\Illuminate\Support\helpers_new::collect();
    }
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect(sscanf($this->value, $format));
    }
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect(Str::ucsplit($this->value));
    }
     ...
     *
     * @return \Fy97Validation\Illuminate\Support\HtmlString
     */
    ...
    /**
     * Get the underlying string value as a Fy97Validation\Carbon instance.
     *
     * @param  string|null  $format
     * @param  string|null  $tz
     * @return \Fy97Validation\Illuminate\Support\Carbon
     *
     * @throws \Fy97Validation\Carbon\Exceptions\InvalidFormatException
     */
