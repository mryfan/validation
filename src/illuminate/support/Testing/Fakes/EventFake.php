...
use Closure;
use Fy97Validation\Illuminate\Contracts\Events\Dispatcher;
...
class EventFake implements Dispatcher, Fake
{
     ...
     *
     * @var \Fy97Validation\Illuminate\Contracts\Events\Dispatcher
     */
    public $dispatcher;
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Events\Dispatcher  $dispatcher
    ...
    public function dispatched($event, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->events[$event])->filter(
    ...
    protected function shouldFakeEvent($eventName, $payload)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->eventsToFake)
    ...
    protected function shouldDispatchEvent($eventName, $payload)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->eventsToDispatch)
            ->filter(function ($event) use ($eventName, $payload) {
                return $event instanceof Closure
                    ? $event($eventName, $payload)
                    : $event === $eventName;
