...
use Closure;
use Exception;
use Fy\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Fy\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use Fy\Illuminate\Contracts\Translation\HasLocalePreference;
use Fy\Illuminate\Support\Collection;
use Fy\Illuminate\Support\Str;
use Fy\Illuminate\Support\Traits\Macroable;
use Fy\Illuminate\Support\Traits\ReflectsClosures;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
     ...
     * @param  string  $notification
     * @param  callable|null  $callback
     * @return \Fy\Illuminate\Support\Collection
     */
     ...
     *
     * @param  \Fy\Illuminate\Support\Collection|array|mixed  $notifiables
