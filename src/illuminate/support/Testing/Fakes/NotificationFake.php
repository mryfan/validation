...
use Closure;
use Exception;
use Fy97Validation\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Fy97Validation\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use Fy97Validation\Illuminate\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements Fake, NotificationDispatcher, NotificationFactory
{
    ...
    {
        $actualCount = \Fy97Validation\Illuminate\Support\helpers_new::collect($this->notifications)
            ->flatten(1)
    ...
    {
        $actualCount = \Fy97Validation\Illuminate\Support\helpers_new::collect($this->notifications)->flatten(3)->count();
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = \Fy97Validation\Illuminate\Support\helpers_new::collect($this->notificationsFor($notifiable, $notification));
    ...
    public function sendNow($notifiables, $notification, array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? \Fy97Validation\Illuminate\Support\helpers_new::value(function () use ($notifiable) {
