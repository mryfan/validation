...
use Closure;
use Fy97Validation\Illuminate\Contracts\Queue\Queue;
...
class QueueFake extends QueueManager implements Fake, Queue
{
     ...
     *
     * @var \Fy97Validation\Illuminate\Contracts\Queue\Queue
     */
    public $queue;
     ...
     *
     * @var \Fy97Validation\Illuminate\Support\Collection
     */
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Foundation\Application  $app
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->jobs[$job])->filter(
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->jobs)->flatten(1)->filter(
     ...
     *
     * @param  string|null  $queue
     * @return \Fy97Validation\Illuminate\Contracts\Queue\Job|null
     */
