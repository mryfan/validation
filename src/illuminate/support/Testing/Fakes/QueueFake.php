...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {
