...
use Closure;
use Fy\Illuminate\Contracts\Mail\Factory;
use Fy\Illuminate\Contracts\Mail\Mailable;
use Fy\Illuminate\Contracts\Mail\Mailer;
use Fy\Illuminate\Contracts\Mail\MailQueue;
use Fy\Illuminate\Contracts\Queue\ShouldQueue;
...
class MailFake implements Factory, Mailer, MailQueue
{
     ...
     *
     * @param  \Fy\Illuminate\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
