...
class BusFake implements QueueingDispatcher
{
    ...
    {
        $chain = \Fy97Validation\Illuminate\Support\helpers_new::collect($expectedChain)->map(function ($job) {
    ...
    protected function assertDispatchedWithChainOfClasses($command, $expectedChain, $callback)
    {
        $matching = $this->dispatched($command, $callback)->map->chained->map(function ($chain) {
            return \Fy97Validation\Illuminate\Support\helpers_new::collect($chain)->map(function ($job) {
    ...
    {
        return ! \Fy97Validation\Illuminate\Support\helpers_new::collect($chain)->contains(function ($job) {
    ...
    public function dispatched($command, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->commands[$command])->filter(function ($command) use ($callback) {
    ...
    public function dispatchedSync(string $command, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->commandsSync[$command])->filter(function ($command) use ($callback) {
            return $callback($command);
        });
    }
    ...
    public function dispatchedAfterResponse(string $command, $callback = null)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->commandsAfterResponse[$command])->filter(function ($command) use ($callback) {
            return $callback($command);
        });
    }
    ...
    public function batched(callable $callback)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->batches)->filter(function ($batch) use ($callback) {
