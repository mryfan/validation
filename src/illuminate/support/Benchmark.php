...
class Benchmark
{
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect(Arr::wrap($benchmarkables))->map(function ($callback) use ($iterations) {
            return \Fy97Validation\Illuminate\Support\helpers_new::collect(range(1, $iterations))->map(function () use ($callback) {
                gc_collect_cycles();
    ...
    {
        $result = \Fy97Validation\Illuminate\Support\helpers_new::collect(static::measure(Arr::wrap($benchmarkables), $iterations))
