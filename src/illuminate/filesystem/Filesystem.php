...
use Fy97Validation\Illuminate\Contracts\Filesystem\FileNotFoundException;
use Fy97Validation\Illuminate\Support\LazyCollection;
...
use Fy97Validation\Symfony\Component\Finder\Finder;
...
class Filesystem
{
    ...
    {
        if (! \Fy97Validation\Illuminate\Support\helpers1_new::windows_os()) {
     ...
     * @param  string  $directory
     * @param  bool  $hidden
     * @return \Fy97Validation\Symfony\Component\Finder\SplFileInfo[]
     */
