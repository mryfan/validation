...
class FileLoader implements Loader
{
     ...
     *
     * @var \Fy97Validation\Illuminate\Filesystem\Filesystem
     */
    protected $files;
     ...
     *
     * @param  \Fy97Validation\Illuminate\Filesystem\Filesystem  $files
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->paths)
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($paths)
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect(array_merge($this->jsonPaths, $this->paths))
