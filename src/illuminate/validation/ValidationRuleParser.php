...
class ValidationRuleParser
{
    ...
    {
        $merge = \Fy97Validation\Illuminate\Support\helpers_new::head($this->explodeRules([$rules]));
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($rules)->mapWithKeys(function ($attributeRules, $attribute) use ($data) {
            ...
            return [$attribute => \Fy97Validation\Illuminate\Support\helpers_new::collect($attributeRules)->map(function ($rule) use ($data) {
