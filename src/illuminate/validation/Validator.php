...
use Fy\Illuminate\Contracts\Container\Container;
use Fy\Illuminate\Contracts\Translation\Translator;
use Fy\Illuminate\Contracts\Validation\DataAwareRule;
use Fy\Illuminate\Contracts\Validation\ImplicitRule;
use Fy\Illuminate\Contracts\Validation\Rule as RuleContract;
use Fy\Illuminate\Contracts\Validation\Validator as ValidatorContract;
use Fy\Illuminate\Contracts\Validation\ValidatorAwareRule;
use Fy\Illuminate\Support\Arr;
use Fy\Illuminate\Support\Fluent;
use Fy\Illuminate\Support\MessageBag;
use Fy\Illuminate\Support\Str;
use RuntimeException;
use stdClass;
use Fy\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Fy\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Fy\Illuminate\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \Fy\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Fy\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \Fy\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Fy\Illuminate\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     * @return \Fy\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Fy\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Fy\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \Fy\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
