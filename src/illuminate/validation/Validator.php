...
use Fy97Validation\Illuminate\Contracts\Translation\Translator;
use Fy97Validation\Illuminate\Contracts\Validation\DataAwareRule;
use Fy97Validation\Illuminate\Contracts\Validation\ImplicitRule;
use Fy97Validation\Illuminate\Contracts\Validation\Rule as RuleContract;
use Fy97Validation\Illuminate\Contracts\Validation\Validator as ValidatorContract;
use Fy97Validation\Illuminate\Contracts\Validation\ValidatorAwareRule;
use Fy97Validation\Illuminate\Support\Arr;
use Fy97Validation\Illuminate\Support\Fluent;
use Fy97Validation\Illuminate\Support\MessageBag;
use Fy97Validation\Illuminate\Support\Str;
use Fy97Validation\Illuminate\Support\ValidatedInput;
use InvalidArgumentException;
use RuntimeException;
use stdClass;
use Fy97Validation\Symfony\Component\HttpFoundation\File\UploadedFile;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Fy97Validation\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Fy97Validation\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Fy97Validation\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
    ...
    {
        \Fy97Validation\Illuminate\Support\helpers1_new::throw_if($this->fails(), $this->exception, $this);
     ...
     * @return \Fy97Validation\Illuminate\Support\ValidatedInput|array
     */
    ...
    {
        \Fy97Validation\Illuminate\Support\helpers1_new::throw_if($this->invalid(), $this->exception, $this);
        ...
        foreach ($this->getRules() as $key => $rules) {
            ...
            $value = \Fy97Validation\Illuminate\Support\helpers_new::data_get($this->getData(), $key, $missingValue);
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Fy97Validation\Illuminate\Contracts\Validation\Rule  $rule
     * @return void
     */
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->messages()->toArray())->map(function ($message, $key) {
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->rules)
    ...
    {
        $rules = \Fy97Validation\Illuminate\Support\helpers_new::collect($rules)->mapWithKeys(function ($value, $key) {
     ...
     *
     * @param  string  $attribute
     * @return \Fy97Validation\Illuminate\Support\Fluent|array|mixed
     */
    private function dataForSometimesIteration(string $attribute, $removeLastSegmentOfAttribute)
    {
        ...
        return is_array($data = \Fy97Validation\Illuminate\Support\helpers_new::data_get($this->data, $attribute))
            ? new Fluent($data)
            : $data;
    }
     ...
     * @return \Fy97Validation\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Fy97Validation\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Fy97Validation\Illuminate\Contracts\Translation\Translator
     */
