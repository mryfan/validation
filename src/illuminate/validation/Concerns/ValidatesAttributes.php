...
namespace Fy97Validation\Illuminate\Validation\Concerns;

use Fy97Validation\Brick\Math\BigDecimal;
use Fy97Validation\Brick\Math\BigNumber;
use Fy97Validation\Brick\Math\Exception\MathException as BrickMathException;
use DateTime;
use DateTimeInterface;
use Fy97Validation\Egulias\EmailValidator\EmailValidator;
use Fy97Validation\Egulias\EmailValidator\Validation\DNSCheckValidation;
use Fy97Validation\Egulias\EmailValidator\Validation\Extra\SpoofCheckValidation;
use Fy97Validation\Egulias\EmailValidator\Validation\MultipleValidationWithAnd;
use Fy97Validation\Egulias\EmailValidator\Validation\NoRFCWarningsValidation;
use Fy97Validation\Egulias\EmailValidator\Validation\RFCValidation;
use Exception;
use Illuminate\Database\Eloquent\Model;
use Fy97Validation\Illuminate\Support\Arr;
use Fy97Validation\Illuminate\Support\Exceptions\MathException;
...
use Fy97Validation\Illuminate\Validation\ValidationData;
use InvalidArgumentException;
use Fy97Validation\Symfony\Component\HttpFoundation\File\File;
...
trait ValidatesAttributes
{
    ...
    public function validateBetween($attribute, $value, $parameters)
    {
        ...
        return \Fy97Validation\Illuminate\Support\helpers1_new::with(
    ...
    public function validateEmail($attribute, $value, $parameters)
    {
        ...
        $validations = \Fy97Validation\Illuminate\Support\helpers_new::collect($parameters)
            ->unique()
    ...
    public function guessColumnForQuery($attribute)
    {
        if (in_array($attribute, Arr::collapse($this->implicitAttributes))
                && ! is_numeric($last = \Fy97Validation\Illuminate\Support\helpers_new::last(explode('.', $attribute)))) {
            return $last;
        }
