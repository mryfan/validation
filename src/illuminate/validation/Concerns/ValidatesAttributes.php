...
namespace Fy\Illuminate\Validation\Concerns;

use Countable;
use DateTime;
use DateTimeInterface;
use Fy\Egulias\EmailValidator\EmailValidator;
use Fy\Egulias\EmailValidator\Validation\DNSCheckValidation;
use Fy\Egulias\EmailValidator\Validation\MultipleValidationWithAnd;
use Fy\Egulias\EmailValidator\Validation\NoRFCWarningsValidation;
use Fy\Egulias\EmailValidator\Validation\RFCValidation;
use Fy\Egulias\EmailValidator\Validation\SpoofCheckValidation;
use Exception;
...
use Fy\Illuminate\Validation\ValidationData;
use InvalidArgumentException;
use Fy\Symfony\Component\HttpFoundation\File\File;
