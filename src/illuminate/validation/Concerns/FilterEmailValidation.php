...
use Fy\Egulias\EmailValidator\Validation\EmailValidation;
...
class FilterEmailValidation implements EmailValidation
{
     ...
     *
     * @param  string  $email
     * @param  \Fy\Egulias\EmailValidator\EmailLexer  $emailLexer
     * @return bool
     */
     ...
     *
     * @return \Fy\Egulias\EmailValidator\Exception\InvalidEmail|null
     */
