...
class Password implements Rule, DataAwareRule, ValidatorAwareRule
{
     ...
     *
     * @var \Fy97Validation\Illuminate\Contracts\Validation\Validator
     */
    protected $validator;
     ...
     *
     * @param  \Fy97Validation\Illuminate\Contracts\Validation\Validator  $validator
     * @return $this
     */
    ...
    {
        $messages = \Fy97Validation\Illuminate\Support\helpers_new::collect(Arr::wrap($messages))->map(function ($message) {
