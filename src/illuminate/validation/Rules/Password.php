...
namespace Fy\Illuminate\Validation\Rules;

use Fy\Illuminate\Container\Container;
use Fy\Illuminate\Contracts\Validation\DataAwareRule;
use Fy\Illuminate\Contracts\Validation\Rule;
use Fy\Illuminate\Contracts\Validation\UncompromisedVerifier;
use Fy\Illuminate\Contracts\Validation\ValidatorAwareRule;
use Fy\Illuminate\Support\Arr;
use Fy\Illuminate\Support\Facades\Validator;
use Fy\Illuminate\Support\Traits\Conditionable;
...
class Password implements Rule, DataAwareRule, ValidatorAwareRule
{
     ...
     *
     * @var \Fy\Illuminate\Contracts\Validation\Validator
     */
    protected $validator;
     ...
     *
     * @param \Fy\Illuminate\Contracts\Validation\Validator $validator
     * @return $this
     */
