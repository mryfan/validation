...
trait DatabaseRule
{
     ...
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array|string|int|bool|null  $value
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array|string  $value
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Fy97Validation\Illuminate\Contracts\Support\Arrayable|array  $values
     * @return $this
     */
    ...
    {
        return \Fy97Validation\Illuminate\Support\helpers_new::collect($this->wheres)->map(function ($where) {
